...
import { Flag, Eye, EyeOff, Mail, Lock, User } from "lucide-react";
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Create your Velocity Racing account
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <Label htmlFor="email-updates" className="ml-2 text-sm">
                  Send me exclusive racing updates and product launches
                </Label>
              </div>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <Link
                  to="/login"
                  className="font-medium text-racing-red hover:text-racing-red/80"
                >
                  Sign in here
                </Link>
              </p>
